...
> replaced this head and `strange_render`. Nothing here is fetched, shipped or read by
...
> superseded** — `data/smooth_render/` is a live corpus, still collected, still the
