...
def binding_reason(below: int, capped: int, refused: int, withheld: int) -> str:
    ...
    `P(>=3) 0.881` against the floor of 0.770 that acted the day it was recorded.
    Lowering that floor would not have seated it. The field is what a reader
    trusts when deciding whether under-fill is a supply problem or a colour
    problem, and those have opposite remedies.
