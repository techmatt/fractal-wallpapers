...
def durable() -> durability.Durable:
    ...
    It took a `which` while the store held two ledgers side by side and the wide
    one kept a copy and a manifest of its own. The wide ledger was deleted on
    2026-08-29 and there is one sidecar again.
    """
