...
METHOD = (
    ...
    "{quantiles} evenly spaced quantiles. The cut is the midpoint of the widest SAME pair and "
    "the nearest DIFFERENT pair on a 46-pair calibration sheet marked by eye (2026-08-25); "
    "the marks leave no inversions. A group's `canonical` member is the one carrying the most "
    "finished-render label rows, ties broken by name. Regenerated by "
