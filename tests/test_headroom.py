...
def test_the_mode_block_says_whether_its_floors_even_fit_in_n():
    read = headroom.census(clearing_pool(3), ladder=(5, 150), log=lambda *_: None)
    assert read["curve"]["5"]["blocks"]["mode_floors"]["fits_in_n"] is False
    assert read["curve"]["150"]["blocks"]["mode_floors"]["fits_in_n"] is True
